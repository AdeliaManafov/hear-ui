...
def test_dataset_adapters():
    ...
    try:
        ...
        print("✓ Created CochlearImplantDatasetAdapter")
...
def test_model_wrapper_adapters():
    ...
    try:
        ...
        if wrapper.is_loaded():
            ...
            print(
                f"  - Model type: {wrapper.model_adapter.get_model_type() if wrapper.model_adapter else 'N/A'}"
            )
...
def test_explainer_with_model():
    ...
    try:
        ...
        explanation = explainer.explain(
            model=wrapper.model, input_data=X, feature_names=wrapper.get_feature_names()
        )
