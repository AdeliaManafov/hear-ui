...
def preprocess_patient_data(raw: dict) -> np.ndarray:
    ...
    diagnosis_ordinal = {
        "Diagnose.Höranamnese.Hörminderung operiertes Ohr...": ["hearing_loss_operated", "hoerminderung_op"],
        "Diagnose.Höranamnese.Zeitpunkt des Hörverlusts (OP-Ohr)...": ["time_of_loss", "zeitpunkt"],
        "Diagnose.Höranamnese.Beginn der Hörminderung (OP-Ohr)...": ["onset", "beginn", "hearing_loss_onset"],
    ...
    ORDINAL_MAPPINGS = {
        ...
        "praelingual": 1.0, "prälingual": 1.0, "prelingual": 1.0, "< 1 y": 1.0,
        "perilingual": 2.0, "1-2 y": 2.0, "1-5 y": 2.0,
        "postlingual": 3.0, "> 20 y": 3.0, "10-20 y": 3.0, "5-10 y": 3.0,
        # Zeitpunkt
        "erworben – prälingual": 1.0, "erworben - prälingual": 1.0,
        "erworben - perilingual": 2.0,
        "erworben - postlingual": 3.0, "erworben – postlingual": 3.0,
        "angeboren": 0.0, "kongenital": 0.0,
        # Hearing loss severity
        "hochgradiger hv": 2.0, "hochgradig": 2.0,
        "taubheit (profound hl)": 3.0, "taubheit": 3.0, "profound": 3.0,
