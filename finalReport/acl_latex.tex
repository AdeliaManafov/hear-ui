...
\setlength{\parindent}{0pt}
  ...
  \begin{abstract}
    ...
    follows a RESTful architecture with comprehensive test coverage (46 test
  ...
  \begin{itemize}
    ...
    \item \textbf{Tests}: 46 test files with 394 test functions covering unit,
  ...
  \begin{itemize}
    \item \textbf{Unit tests}: 394 test functions across 46 test files covering model
    ...
    \item \textbf{Code quality}: Automated linting and formatting with Ruff (backend)
      and ESLint (frontend), achieving 67\% test coverage
  ...
  46 test files with 90 percent test coverage), the complete setup of the CI/CD pipeline
  ...
  \begin{itemize}
    \item \textbf{Backend}: Python 3.12, FastAPI 0.121.1, scikit-learn 1.6.1, SHAP 0.49.1, SQLModel 0.0.27, Alembic 1.17.1
