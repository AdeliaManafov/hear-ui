...
\begin{document}
  ...
  Our system uses clinical data from cochlear implant patients collected at a German
  university hospital. The dataset contains patient records with the following
  ...
  where $\beta_{0}$ is the intercept and $\beta$ are the learned coefficients.
  ...
  \begin{itemize}
    \item \textbf{Prediction range}: Model outputs span 0.22--1.0 probability
      range, avoiding extreme values and indicating reasonable calibration without
      overfitting
  ...
  tasks on the SHAP and gathered frontend feedback. He was also responsible for creating
  the demo video.
  ...
  contributed to the successful completion of this work. This study was carried out
  as part of a course project at the University of Marburg.
  \bibliography{custom}
